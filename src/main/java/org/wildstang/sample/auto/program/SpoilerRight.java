...
public class SpoilerRight extends AutoProgram {
    ...
    public void defineSteps() {
        ...
        group2.addStep(new SwervePathFollowerStep("SpoilerRight1", swerve));
        AutoSerialStepGroup group22 = new AutoSerialStepGroup();
        group22.addStep(new AutoStepDelay(1800));
        group22.addStep(new SetIntakeStep(true));
        group2.addStep(group22);
        addStep(group2);
