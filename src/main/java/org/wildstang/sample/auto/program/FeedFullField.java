...
import org.wildstang.sample.auto.steps.SetConstantLauncherStep;
import org.wildstang.sample.auto.steps.SetGyroStep;



public class FeedFullField extends AutoProgram {
    ...
    public void defineSteps() {
        ...
        group1.addStep(new SwervePathFollowerStep("OverLeftBump6", swerve));
        addStep(group1);

        AutoParallelStepGroup group2 = new AutoParallelStepGroup();
        group2.addStep(new SwervePathFollowerStep("ToMidBalls6", swerve));
        group2.addStep(new SetIntakeStep(true));
        group2.addStep(new SetConstantLauncherStep(true));
        addStep(group2);

        AutoParallelStepGroup group3 = new AutoParallelStepGroup();
        group3.addStep(new SwervePathFollowerStep("AcrossMidBalls6", swerve));
        addStep(group3);

        AutoParallelStepGroup group4 = new AutoParallelStepGroup();
        group4.addStep(new SwervePathFollowerStep("ToRightBump6", swerve));
        group4.addStep(new SetIntakeStep(false));
        group4.addStep(new SetConstantLauncherStep(false));
        addStep(group4);

        AutoParallelStepGroup group5 = new AutoParallelStepGroup();
        group5.addStep(new SwervePathFollowerStep("OverRightBump6", swerve));
        addStep(group5);

        AutoParallelStepGroup group6 = new AutoParallelStepGroup();
        group6.addStep(new SwervePathFollowerStep("ToClimb6", swerve));
        addStep(group6);
